...
"}")
    ...
    def check_wants(self):
        try: 
            ...
            cursor = data.cursor()
            cursor.execute("SELECT needs FROM stoge_data WHERE iduser = %s ORDER BY times DESC LIMIT 1", (self.iduser,))
    ...
    def warning(self,checked = False):
        try:
            ...
            if wants :
                ...
                cursor.execute("SELECT SUM(cost) as total_coast from list_wants where iduser = %s",(self.iduser,))
    ...
    def one(self):
        ...
        try:
            ...
            cursor = data.cursor()
            cursor.execute("INSERT INTO list_wants (iduser , name_wants , cost , times) VALUES (%s, %s , %s , NOW())", (self.iduser , name , 100000))
            data.commit()
    ...
    def two(self):
        ...
        try:
            ...
            cursor = data.cursor()
            cursor.execute("INSERT INTO list_wants (iduser , name_wants , cost ,times) VALUES (%s, %s , %s , NOW())", (self.iduser , name , 200000))
            data.commit()
            QtWidgets.QMessageBox.information(None, "Success", "Data has been saved")
            self.warning(False)
    ...
    def five(self):
        ...
        try:
            ...
            cursor = data.cursor()
            cursor.execute("INSERT INTO list_wants(iduser , name_wants, cost ,NOW()) VALUES (%s, %s , %s)", (self.iduser , name , 500000))
            data.commit()
            QtWidgets.QMessageBox.information(None, "Success", "Data has been saved")
    ...
    def option(self):
        ...
        try:
            ...
            cursor = data.cursor()
            cursor.execute("INSERT INTO list_wants(iduser , name_wants, cost , times) VALUES (%s, %s , %s , NOW())", (self.iduser , name , cost ))
            data.commit()
            QtWidgets.QMessageBox.information(None, "Success", "Data has been saved")
            self.warning(False)
