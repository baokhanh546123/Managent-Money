...
class Ui_Form(object):
    ...
    def search(self):
        ...
        try : 
            ...
            cursor = data.cursor()
            cursor.execute("""SELECT name_savings , cost  from list_savings where iduser = %s AND name_savings = %s
                           """,(self.iduser , list_name_savings,))
    ...
    def delete(self):
        ...
        try : 
            ...
            if check[0] == 0 : 
                ...
                cursor.execute("DELETE FROM list_savings WHERE iduser = %s AND name_savings = %s",(self.iduser , list_name_savings , ))
                data.commit()
