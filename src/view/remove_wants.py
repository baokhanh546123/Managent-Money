...
class Ui_Form(object):
    ...
    def search(self):
        ...
        try : 
            ...
            cursor = data.cursor()
            cursor.execute("SELECT ten , cost  from wants where iduser = %s AND ten LIKE %s",(self.iduser , f"%{list_name_wants}%",))
    ...
    def delete(self):
        ...
        try : 
            ...
            if check[0] == 0 : 
                ...
                cursor.execute("DELETE FROM wants WHERE iduser = %s AND ten = %s",(self.iduser , list_name_wants , ))
                data.commit()
